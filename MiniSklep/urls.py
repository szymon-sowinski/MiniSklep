...
from MiniSklepApp.views import add_product, display_products, login_view, logout_view, update_product, delete_product, delete_selected_products, delete_all_products
